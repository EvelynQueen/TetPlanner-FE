...
export default function DeleteConfirmModal({ isOpen, name, onClose, onConfirm }) {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60">
      <div className="relative w-[480px] bg-white rounded-2xl border border-slate-200 shadow-[0_25px_50px_0_rgba(0,0,0,0.25)] overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-8 pt-8 pr-8 pb-12 pl-8">
          ...
          <div className="flex flex-col items-center gap-1 text-center">
            <span className="font-['Plus_Jakarta_Sans'] text-[26px] font-bold leading-[32px] text-slate-800">
              Xác nhận xóa
            </span>
            <span className="font-['Plus_Jakarta_Sans'] text-sm text-slate-500 max-w-[320px]">
